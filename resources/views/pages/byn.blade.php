    ...
    <div class="w-full relative">
        ...
        <div class="relative h-72 flex items-center justify-center overflow-hidden">
            <img src="{{ asset('images/portada.jpg') }}" alt="Encabezado de la página"
                class="absolute inset-0 w-full h-full object-cover transition duration-500 ease-in-out transform hover:scale-110">
            <div class="absolute inset-0 bg-black opacity-40"></div>
            <div class="z-10 text-center text-white">
                <h1 class="font-extrabold text-4xl text-red-700 animate-pulse">Archivo Fotográfico Y Fílmico Del Chocó
                </h1>
                <h2 class="text-xl mt-2">Publicaciones</h2>
                <nav class="flex justify-center my-4 text-sm" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-3 text-white">
                        <li class="inline-flex items-center gap-2">
                            ...
                            <a href="/" class="hover:text-red-500 transition duration-300">Inicio</a> /
                        </li>
                        <li class="inline-flex items-center">
                            <a href="/byne" class="hover:text-red-500 transition duration-300">Publicaciones</a>
                        </li>
                    </ol>
                </nav>
            </div>
        ...
        <!-- Contenido Principal -->
        <div class="container mx-auto px-4 py-8 bg-gray-100 text-black flex flex-col md:flex-row">
            <!-- Contenido principal -->
            <div class="md:w-2/3">
                <!-- Sección 1: FOTOGRAFÍA EN EL CHOCO -->
                <div class="mb-8 bg-white p-6 rounded-lg shadow-lg transition transform hover:scale-105">
                    <h2 class="text-2xl md:text-3xl font-bold text-red-500 mb-2">Documento <a
                            ...
                            target="_blank" class="hover:text-red-700">“FOTOGRAFIA EN EL CHOCO”</a></h2>
                ...
                <div class="mb-8 bg-white p-6 rounded-lg shadow-lg transition transform hover:scale-105">
                    <h2 class="text-2xl md:text-3xl font-bold text-red-500 mb-2">Documento <a
                            ...
                            target="_blank" class="hover:text-red-700">“EL CINE EN EL CHOCO”</a></h2>
                    <p class="text-justify text-base md:text-lg">
                ...
                <div class="mb-8 bg-white p-6 rounded-lg shadow-lg transition transform hover:scale-105">
                    <h2 class="text-2xl md:text-3xl font-bold text-red-500 mb-2"><a
                            ...
                            class="hover:text-red-700">Videoteca del Pacífico</a></h2>
                    <p class="text-justify text-base md:text-lg">
                ...
                <div class="mb-8 bg-white p-6 rounded-lg shadow-lg transition transform hover:scale-105">
                    <h2 class="text-2xl md:text-3xl font-bold text-red-500 mb-2">Investigación Curatorial: <a
                            ...
                            class="hover:text-red-700">"Ahí está pintado el Chocó"</a></h2>
                    <p class="text-justify text-base md:text-lg">
                ...
                <div class="mb-8 bg-white p-6 rounded-lg shadow-lg transition transform hover:scale-105">
                    <h2 class="text-2xl md:text-3xl font-bold text-red-500 mb-2">Proyecto <a
                            ...
                            target="_blank" class="hover:text-red-700">"Desandando" Tras los Archivos
            ...
            <div class="md:w-1/3 md:pl-8 flex flex-col items-center text-white rounded-lg shadow-lg p-6 bg-black">
                <!-- Imagen 1 -->
                <div class="mb-6 w-full">
                    <img src="{{ asset('/images/publicacion1.jpg') }}" alt="Imagen principal del Chocó"
